...
<head>
    ...
    <title>Informasi Dokumen KP</title>
														...
														<div class="row">
																<div class="col">
																	<div class="alert alert-success">
																			<strong>Sukses <?php echo $event ?> Informasi Berkas KP "<?php echo $Judul ?>"</strong>
																	</div>
																</div>
															</div>
													<?php
													...
													<div class="row">
														<div class="col-lg-12 nopadding">
															<div class="section_title text-center">
																	<h1 >Informasi Dokumen KP</h1>
															</div>
														</div>
													</div>
													<div class="row">
														<div class="col-md-1.5">
														<?php echo form_open("PageController/cariDokumenKPMahasiswa"); ?>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Kelola Data Berkas KP</h4>
