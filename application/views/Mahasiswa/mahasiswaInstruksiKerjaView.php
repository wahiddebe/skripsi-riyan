...
<head>
    ...
    <title>Informasi Instruksi Kerja</title>
														...
														<div class="row">
																<div class="col">
																	<div class="alert alert-success">
																			<strong>Sukses <?php echo $event ?> Informasi Instruksi Kerja "<?php echo $Judul ?>"</strong>
																	</div>
																</div>
															</div>
													<?php
													...
													<div class="row">
														<div class="col-lg-12 nopadding">
															<div class="section_title text-center">
																	<h1 >Informasi Instruksi Kerja</h1>
															</div>
														</div>
													</div>
													<div class="row">
														<div class="col-md-1.5">
														<?php echo form_open("PageController/cariInstruksiKerjaMahasiswa"); ?>
