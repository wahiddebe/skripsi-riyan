                        ...
                        <div class="signup-content">
                            <div class="signup-form">
                                ...
                                <div class="section_title">
                                    <h1>Form Pendaftaran Magang</h1>
                                </div>
                                <?php
                                echo form_open_multipart('/mahasiswa/FormMagang', array('id' => 'register-form', 'class' => 'register-form'));
                                ?>
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <div class="form-input">
                                            <label for="Program_Magang" class="required">Program Magang</label>
                                            <input required class="form-control-input-sm" type="text" name="Program_Magang" id="Program_Magang" />
                                        </div>
                                        <div class="form-input">
                                    ...
                                    <div class="form-group">
                                        <div class="form-input">
                                            <label for="Tanggal_Magang" class="required">Tanggal Pelaksanaan Magang (contoh: 03-05-2015 sampai 10-07-2015)</label>
                                            <input required class="form-control-input-sm" type="text" name="Tanggal_Magang" id="Tanggal_Magang" />
                                        </div>
                                        ...
                                        <div class="form-input">
                                            <label for="SuratRekomendasiFakultas" class="required">Upload Surat rekomendasi Fakultas</label>
                                            <input required class="form-control-input-sm" type="file" name="SuratRekomendasiFakultas" id="SuratRekomendasiFakultas" />
                                        </div>
                                        <div class="form-input">
                                            <label for="SPTJM" class="required">Upload SPTJM Mahasiswa</label>
                                            <input required class="form-control-input-sm" type="file" name="SPTJM" id="SPTJM" />
                                        </div>
                                    </div>
                                </div>
