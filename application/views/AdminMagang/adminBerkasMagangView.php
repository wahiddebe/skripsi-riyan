...
<head>
	...
	<title>Kelola Dokumen Magang</title>
								...
								<div class="register_content ">
											...
											<div class="row">
												<div class="col">
													<div class="alert alert-success">
														<strong>Sukses <?php echo $event ?> data Berkas Magang "<?php echo $Judul ?>"</strong>
													</div>
												</div>
											</div>
									<?php
									...
									<div class="row">
										<div class="col-lg-12 nopadding">
											<div class="section_title text-center">
												<h1>Data Dokumen Magang</h1>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-1.5">
											<?php echo form_open("PageController/cariDokumenMagang"); ?>
									...
									<div class="row">
										<div class="col-lg-2 offset-md-10">
											<button type='button' style='margin-bottom:5px' class='btn btn-success' data-toggle='modal' data-target='#myModal' data-form='/adminMagang/getBerkasMagang/-1'>
												Tambah
											</button>
										</div>
									</div>
												...
												<table class="table table-responsive-sm table-hover table-outline mb-0">
													...
													<tbody>
														...
														foreach ($list as $BerkasMagang) {
															...
															echo "	</td>";
															echo "	<td>";
															echo $BerkasMagang->TanggalPembuatan;
															echo "	</td>";
															echo "	<td>";
															...
															echo "    <button type='button' class='btn btn-primary' 
																						...
																						data-form='/adminMagang/getBerkasMagang/" . $BerkasMagang->IdBerkas . "'>
																						Ubah
																						</button>";
															echo "    <button type='button' class='btn btn-danger' 
																						data-toggle='modal' data-target='#myModal2' data-form='/adminMagang/hapusBerkasMagang/" . $BerkasMagang->IdBerkas . "/" . $BerkasMagang->Judul . "'>
																						Hapus
																						</button>";
															echo "  </td>";
															echo "</tr>";
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title" id="myModalLabel">Kelola Data Dokumen Magang</h4>
			...
			<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form id='hapusForm' method='POST' action='<?php echo base_url(); ?>adminMagang/hapusBerkasMagang'>
