<div class="main">
    <div class="container">
        <?php
        echo form_open_multipart('/adminMagang/submitBerkasMagang', array('id' => 'register-form', 'class' => 'register-form'));
        ?>
        <?php
        $data = [];
        $nilaiButton = 'Tambah';
        if (isset($BerkasMagang)) {
            $data['IdBerkas'] = $BerkasMagang->IdBerkas;
            $data['judul'] = $BerkasMagang->Judul;
            $data['file'] = $BerkasMagang->File;
            $nilaiButton = 'Ubah';
        } else {
            $data['IdBerkas'] = '';
            $data['judul'] = '';
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="form-input">
                    ...
                    ?>
                        <input type="button" id='btn_changeFile' class="btn-x" value='X' onclick="
