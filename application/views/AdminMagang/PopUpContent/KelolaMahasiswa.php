        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="signup-form">
                    <?php
                    echo form_open('/adminMagang/submitMahasiswa', array('id' => 'register-form', 'class' => 'register-form'));
                    ?>
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-select">
                                <div class="label-flex">
                                    <label for="dosen1">Status Magang</label>
                                </div>
                                <div class="select-list">
                                    <select class="selectData" name="StatusMagang" id="StatusMagang">
                                        <?php
                                        $list = ['Aktif', 'Lulus'];
                                        foreach ($list as $item) {
                                            $value = "<option value='" . $item . "'";
                                            if ($mahasiswa->StatusMagang == $item) {
