			...
			<div>
						...
						<div class="col-lg-12 nopadding">
							<div class="register_section d-flex flex-column">
								<div class="register_content ">
									...
									<div class="row">
										<div class="col">
											<div class="section_title text-center">
												<h1>Data Kerja Magang Tersetujui</h1>
											</div>
										</div>
									</div>
									<div class="row">
									...
									<a class="btn btn-success" href="<?php echo base_url() . 'PageController/export_excelMagang' ?>">Export Excel</a>
									<br>
									<br>
									<div class="row">
										<div class="col">
											<div class="list-data">
												<div class="col-md-12">
													<table id="Magang_data" class="table table-bordered" cellspacing="0" width="99%">
														<thead>
															<tr>
																<!-- <td>No</td> -->
																<td>
																...
																<td>
																	<center>Program Magang
																</td>
																<td>
																	<center>Nama Perusahaan
																</td>
																<td>
																	<center>Tanggal Magang
																</td>
																<td>
																	<center>Dosen Pembimbing
																</td>
																<td>
																	<center>Surat Perusahaan
																</td>
																<td>
														...
														<tbody>
															...
															foreach ($list as $magang) {
																...
																echo "	</td>";
																echo "	<td><center>";
																echo $magang->DosenPembimbing;
																echo "	</td>";
																echo "	<td><center>";
																if ($magang->SuratPenerimaanPerusahaan != '') {
																	echo "<a target='_blank' href='" . base_url() . $magang->SuratPenerimaanPerusahaan . "'> Surat.pdf</a>";
																} else {
																	echo "-";
																}
																echo "	</td>";
																...
																echo "    <button type='button' class='btn btn-primary' 
																						...
																						data-form='/adminMagang/getMagang/" . $magang->IdMagang . "/" . $magang->DosenPembimbing . "'>
																						Ubah
																						</button>";
																echo "    <button type='button' class='btn btn-danger' 
																			data-toggle='modal' data-target='#myModal2' data-form='/adminMagang/hapusMagang/" . $magang->IdMagang . "/" . $magang->NIM . "'>
																			Hapus
																			</button>";
																echo "  </td>";
																echo "</tr>";
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h4 class="modal-title" id="myModalLabel">Ubah Data Magang</h4>
				...
				<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h4 class="modal-title" id="myModalLabel">Hapus Data Magang</h4>
								<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
							</div>
							<div class="modal-body">
								<form id='hapusForm' method='POST' action='<?php echo base_url(); ?>adminMagang/hapusMagang'>
