...
<head>
	...
	<title>Data Perusahaan Magang</title>
		...
		<main>
					...
					<div class="col-lg-12 nopadding">
						<div class="register_section d-flex flex-column">
							<div class="register_content ">
								...
								<div class="row">
									<div class="col-lg-12 nopadding">
										<div class="section_title text-center">
											<h1>Data Perusahaan Magang</h1>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-12">
										<?php echo form_open("PageController/cariPerusahaanMagang"); ?>
										<select name="cariberdasarkan">
											...
											<option value="Perusahaan_4">Perusahaan 4</option>
											<option value="Bidang_Perusahaan4">Bidang Perusahaan 4</option>
											<option value="Perusahaan_5">Perusahaan 5</option>
											<option value="Bidang_Perusahaan5">Bidang Perusahaan 5</option>
								...
								<br>
								<a class="btn btn-success" href="<?php echo base_url() . 'PageController/export_excelPerusahaanMagang' ?>">Export Excel</a>
								<br>
								<div class="row">
									<div class="col">
										<div class="list-data">
											<table class="table table-responsive-sm table-hover table-outline mb-0">
												<thead>
													<tr>
														...
														<td>
															<center>Bidang Perusahaan 1
														</td>
														<td>
															<center>Perusahaan 2
														</td>
														<td>
															<center>Bidang Perusahaan 2
														</td>
														<td>
															<center>Perusahaan 3
														</td>
														<td>
															<center>Bidang Perusahaan 3
														</td>
														<td>
															<center>Perusahaan 4
														</td>
														<td>
															<center>Bidang Perusahaan 4
														</td>
														<td>
															<center>Perusahaan 5
														</td>
														<td>
															<center>Bidang Perusahaan 5
														</td>
														<td>
															<center>Aksi
														</td>
												...
												<tbody>
													...
													$no = 1;
													foreach ($list as $PerusahaanMagang) {
														echo "<tr>";
														echo "	<td>";
														echo $PerusahaanMagang->NIM;
														echo "	</td>";
														echo "	<td>";
														echo $PerusahaanMagang->Perusahaan_1;
														echo "	</td>";
														echo "	<td>";
														echo $PerusahaanMagang->Bidang_Perusahaan1;
														echo "	</td>";
														echo "	<td>";
														if ($PerusahaanMagang->Perusahaan_2 == '') {
															echo $PerusahaanMagang->Perusahaan_2;
														} else {
															echo "-";
														}
														echo "  </td>";
														echo "	<td>";
														if ($PerusahaanMagang->Bidang_Perusahaan2 == '') {
															echo $PerusahaanMagang->Bidang_Perusahaan2;
														} else {
															echo "-";
														}
														echo "  </td>";
														echo "	<td>";
														if ($PerusahaanMagang->Perusahaan_3 == '') {
															echo $PerusahaanMagang->Perusahaan_3;
														} else {
															echo "-";
														}
														echo "  </td>";
														echo "	<td>";
														if ($PerusahaanMagang->Bidang_Perusahaan3 == '') {
															echo $PerusahaanMagang->Bidang_Perusahaan3;
														} else {
															echo "-";
														}
														echo "  </td>";
														echo "	<td>";
														if ($PerusahaanMagang->Perusahaan_4 == '') {
															echo $PerusahaanMagang->Perusahaan_4;
														} else {
															echo "-";
														}
														echo "  </td>";
														echo "	<td>";
														if ($PerusahaanMagang->Bidang_Perusahaan4 == '') {
															echo $PerusahaanMagang->Bidang_Perusahaan4;
														} else {
															echo "-";
														}
														echo "  </td>";
														echo "	<td>";
														if ($PerusahaanMagang->Perusahaan_5 == '') {
															echo $PerusahaanMagang->Perusahaan_5;
														} else {
															echo "-";
														}
														echo "  </td>";
														echo "	<td>";
														if ($PerusahaanMagang->Bidang_Perusahaan5 == '') {
															echo $PerusahaanMagang->Bidang_Perusahaan5;
														} else {
															echo "-";
														}
														echo "  </td>";
														...
														echo "    <button type='button' class='btn btn-primary' 
																						...
																						data-form='/adminMagang/hapusSuratMagang/" . $PerusahaanMagang->IdMagang . "/" . $PerusahaanMagang->NIM . "/perusahaan'>
																						Hapus
																						</button>";
														echo "  </td>";
														echo "</tr>";
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title" id="myModalLabel">Kelola Data Perusahaan Magang</h4>
			...
			<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title" id="myModalLabel">Hapus Data Perusahaan Magang</h4>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						</div>
						<div class="modal-body">
							<form id='hapusForm' method='POST' action='<?php echo base_url(); ?>adminMagang/hapusSuratMagang/perusahaan'>
