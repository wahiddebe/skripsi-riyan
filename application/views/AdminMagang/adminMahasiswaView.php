								...
								<div class="register_content ">
									...
									<div class="row">
										<div class="col-lg-10 offset-md-11">
											<button type='button' style='margin-bottom:5px' class='btn btn-success' data-toggle='modal' data-target='#myModal3' data-form='/adminMagang/getMahasiswa/-1'>
												Tambah
											</button>
										</div>
									</div>
													...
													<table id="mahasiswa_data" class="table table-bordered" cellspacing="0" width="100%">
														...
														<tbody>
															...
															foreach ($list as $mahasiswa) {
																...
																echo "	</td>";
																echo "	<td>";
																echo $mahasiswa->StatusMagang;
																echo "	</td>";
																echo "  <td>";
																echo "    <button type='button' class='btn btn-primary' 
																						data-toggle='modal' data-target='#myModal' data-form='/adminMagang/getMahasiswa/" . $mahasiswa->NIM . "'>
																						Ubah
																						</button>";
																echo "    <button type='button' class='btn btn-danger' 
																						data-toggle='modal' data-target='#myModal2' data-form='/adminMagang/resetMahasiswa/" . $mahasiswa->NIM . "'>
																						Reset
																						</button>";
																echo "  </td>";
																echo "</tr>";
