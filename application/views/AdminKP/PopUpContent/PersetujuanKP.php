            ...
            <div class="col-lg-12">
                <div class="signup-form">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-input">
                                ...
                                <?php
                                echo "<a target='_blank' href='" . base_url() . $KP->Transkip . "'>" . $KP->NIM . "_Transksrip.pdf</a>";
                                ?>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-input">
                                <label>Surat PenerimaanP erusahaan</label>
                                <?php
                                echo "<a target='_blank' href='" . base_url() . $KP->SuratPenerimaanPerusahaan . "'>" . $KP->NIM . "_SuratPenerimaanPerusahaan.pdf</a>";
                                ?>
                            </div>
                        </div>
                    </div>
