...
<head>
    ...
    <title>Kelola Instruksi Kerja</title>
    ...
    <div class="super_container"> 
									...
									<div class="row">
											...
											<div class="register_section d-flex flex-column">
												<div class="register_content ">
														...
														<div class="row">
																<div class="col">
																	<div class="alert alert-success">
																			<strong>Sukses <?php echo $event ?> data Instruksi Kerja "<?php echo $Judul ?>"</strong>
																	</div>
																</div>
															</div>
													<?php
													...
													<div class="row">
														...
														<?php echo form_open("PageController/cariInstruksiKerja"); ?>
													...
													<div class="row">
														<div class="col-lg-2 offset-md-10">
																<button type='button' style='margin-bottom:5px' class='btn btn-success'
																	data-toggle='modal' data-target='#myModal'data-form='/adminKP/getInstruksiKerja/-1'>
																	Tambah
																</button>
														</div>
													</div>
                                      ...
                                      <td>Judul</td>
																	...
																	<?php
																		...
																		$no = 1;
																		foreach($list as $InstruksiKerja)
																		{
																			echo "<tr>";
																			echo "	<td>";
																			echo $InstruksiKerja->Judul;
																			echo "	</td>";
																			echo "	<td>";
																			echo $InstruksiKerja->TanggalPembuatan;
																			echo "	</td>";
																			echo "	<td>";
																			if($InstruksiKerja->File != '')
																			{
																				echo "<a target='_blank' href='".base_url().$InstruksiKerja->File."'>".$InstruksiKerja->Judul.".pdf</a>";
																			}
																			else
																			{
																				echo "-";
																			...
																			echo "    <button type='button' class='btn btn-primary' 
																						...
																						data-form='/adminKP/getInstruksiKerja/".$InstruksiKerja->IdInstruksi."'>
																						Ubah
																						</button>";
																			echo "    <button type='button' class='btn btn-danger' 
																						data-toggle='modal' data-target='#myModal2' data-form='/adminKP/hapusInstruksiKerja/".$InstruksiKerja->IdInstruksi."/".$InstruksiKerja->Judul."'>
																						Hapus
																						</button>";
																			echo "  </td>";
																			echo "</tr>"; 
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Kelola Data Instruksi Kerja</h4>
        ...
        <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" 	aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Hapus Data Instruksi Kerja</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              </div>
              <div class="modal-body">
								<form id='hapusForm' method='POST' action='<?php echo base_url(); ?>admin/hapusInstruksiKerja'>
