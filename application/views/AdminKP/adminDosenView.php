												...
												<div class="register_content ">
													...
													<div class="col-lg-10 offset-md-11">
																<button type='button' style='margin-bottom:5px' class='btn btn-success'
																	data-toggle='modal' data-target='#myModal'data-form='/adminKP/getDosen/-1'>
																	Tambah
																</button>
														</div>
													</div>
														...
														<div class="col">
															...
															<table id="table_id" class="table  table-bordered" cellspacing="0" width="100%">
																	...
																	<thead>
																		<tr>
																			<!-- <td>No</td> -->
                                      <td><center>Kode Dosen</td>
																			<td><center>Nama</td>
																			<td><center>Beban Mahasiswa</td>
																			<td><center>Aksi</td>
																		</tr>	
																	</thead>
																	<tbody>
																	<?php
																		...
																		foreach($list as $dosen)
																		{
																			...
																			echo "    <button type='button' class='btn btn-primary' 
																						data-toggle='modal' data-target='#myModal' data-form='/adminKP/getDosen/".$dosen->KodeDosen."'>
																						Ubah
																						</button>";
																			echo "    <button type='button' class='btn btn-danger' 
																						data-toggle='modal' data-target='#myModal2' data-form='/adminKP/hapusDosen/".$dosen->KodeDosen."'>
																						Hapus
																						</button>";
																			echo "  </td>";
																			echo "</tr>"; 
        ...
        <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" 	aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
								<form id='hapusForm' method='POST' action='<?php echo base_url(); ?>adminKP/hapusDosen'>
