												...
												<div class="register_content ">
														...
														<div class="row">
																<div class="col">
																	<div class="alert alert-success">
																			<strong>Pengajuan Kerja Praktek <?php echo $NIM?> berhasil disimpan!</strong>
																	</div>
																</div>
															</div>
													<?php
													...
													<div class="row">
														<div class="col">
															<div class="list-data">
															<div class="col-md-12">
															<table id="PersetujuanKP_data" class="table table-bordered" cellspacing="0" width="99%">
																	<thead>
																		<tr>
																			<!-- <td>No</td> -->
																			<td>NIM</td>
																			<td>Tanggal Pelaksanaan KP</td>
																			<td>Bidang Kajian KP</td>
																			<td>Dosen Usul 1</td>
																			<td>Dosen Usul 2</td>
																			<td>Aksi</td>
																		</tr>	
																	...
																	<?php
																		...
																		foreach($list as $KP)
																		{
																			...
																			echo "    <button type='button' class='btn btn-primary' 
																						...
																						data-form='/adminKP/getKP/". $KP->IdKP."/".$KP->UsulDosen1."/".$KP->UsulDosen2."/nonApprove'>
																						Penyetujuan
																						</button>";
																			echo "  </td>";
																			echo "</tr>"; 
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Penyetujuan KP</h4>
