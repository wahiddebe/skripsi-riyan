		...
		<main>
								...
								<div class="register_content ">
											...
											<div class="row">
												<div class="col">
													<div class="alert alert-success">
														<strong>Sukses <?php echo $event ?> data Berkas KP "<?php echo $Judul ?>"</strong>
													</div>
												</div>
											</div>
									<?php
									...
									<div class="row">
										<div class="col-lg-12 nopadding">
											<div class="section_title text-center">
												<h1>Data Dokumen KP</h1>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-1.5">
											<?php echo form_open("PageController/cariDokumenKP"); ?>
									...
									<div class="row">
										<div class="col-lg-2 offset-md-10">
											<button type='button' style='margin-bottom:5px' class='btn btn-success' data-toggle='modal' data-target='#myModal' data-form='/adminKP/getBerkasKP/-1'>
												Tambah
											</button>
										</div>
									</div>
											...
											<div class="list-data">
												<table class="table table-responsive-sm table-hover table-outline mb-0">
													...
													<tbody>
														...
														$no = 1;
														foreach ($list as $BerkasKP) {
															echo "<tr>";
															echo "	<td>";
															echo $BerkasKP->Judul;
															echo "	</td>";
															echo "	<td>";
															echo $BerkasKP->TanggalPembuatan;
															echo "	</td>";
															echo "	<td>";
															if ($BerkasKP->File != '') {
																echo "<a target='_blank' href='" . base_url() . $BerkasKP->File . "'>" . $BerkasKP->Judul . ".pdf</a>";
															} else {
																echo "-";
															}
															echo "	</td>";
															...
															echo "    <button type='button' class='btn btn-primary' 
																						...
																						data-form='/adminKP/getBerkasKP/" . $BerkasKP->IdBerkas . "'>
																						Ubah
																						</button>";
															echo "    <button type='button' class='btn btn-danger' 
																						data-toggle='modal' data-target='#myModal2' data-form='/adminKP/hapusBerkasKP/" . $BerkasKP->IdBerkas . "/" . $BerkasKP->Judul . "'>
																						Hapus
																						</button>";
															echo "  </td>";
															echo "</tr>";
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title" id="myModalLabel">Kelola Data Dokumen KP</h4>
			...
			<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title" id="myModalLabel">Hapus Data Dokumen KP</h4>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						</div>
						<div class="modal-body">
							<form id='hapusForm' method='POST' action='<?php echo base_url(); ?>adminKP/hapusBerkasKP'>
