													...
													<div class="row">
														<div class="col-lg-2 offset-md-10">
																<button type='button' style='margin-bottom:5px' class='btn btn-success'
																	data-toggle='modal' data-target='#myModal'data-form='/admin/getSOP/-1'>
																	Tambah
																</button>
														</div>
													</div>
																	...
																	<?php
																		...
																		foreach($list as $SOP)
																		{
																			...
																			echo "    <button type='button' class='btn btn-primary' 
																						...
																						data-form='/admin/getSOP/".$SOP->IdSOP."'>
																						Ubah
																						</button>";
																			echo "    <button type='button' class='btn btn-danger' 
																						data-toggle='modal' data-target='#myModal2' data-form='/admin/hapusSOP/".$SOP->IdSOP."/".$SOP->Judul."'>
																						Hapus
																						</button>";
																			echo "  </td>";
																			echo "</tr>"; 
        ...
        <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" 	aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
								<form id='hapusForm' method='POST' action='<?php echo base_url(); ?>admin/hapusSOP'>
