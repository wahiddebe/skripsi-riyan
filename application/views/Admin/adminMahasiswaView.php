													...
													<div class="row">
														<div class="col-lg-10 offset-md-11">
																<button type='button' style='margin-bottom:5px' class='btn btn-success'
																	data-toggle='modal' data-target='#myModal3' data-form='/admin/getMahasiswa/-1'>
																	Tambah
																</button>
														</div>
													</div>
                                      ...
                                      <td>Foto</td>
																	...
																	<?php
																		...
																		foreach($list as $mahasiswa)
																		{
																			...
																			if($mahasiswa->Foto!='')
																			{
																				echo "<img src='".base_url().$mahasiswa->Foto."' alt='Foto Mahasiswa'>";
																			}
																			else
																			{
																			...
																			echo "    <button type='button' class='btn btn-primary' 
																						data-toggle='modal' data-target='#myModal' data-form='/admin/getMahasiswa/".$mahasiswa->NIM."'>
																						Ubah
																						</button>";
																			echo "    <button type='button' class='btn btn-danger' 
																						data-toggle='modal' data-target='#myModal2' data-form='/admin/resetMahasiswa/".$mahasiswa->NIM."'>
																						Reset
																						</button>";
																			echo "  </td>";
																			echo "</tr>"; 
        ...
        <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" 	aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
								<form id='hapusForm' method='POST' action='<?php echo base_url(); ?>admin/resetMahasiswa'>
