														...
														<div class="row">
																<div class="col">
																	<div class="alert alert-success">
																			<strong>Sukses <?php echo $event ?> data User Username <?php echo $Username ?></strong>
																	</div>
																</div>
															</div>
													<?php
	 ...
	 <br>
													...
													<div class="row">
														<div class="col">
															<div class="list-data">
															<div class="col-md-12">
															<table id="User_data" class="table table-bordered" cellspacing="0" width="100%">
																	...
																	<?php
																		...
																		foreach($list as $User)
																		{
																			...
																			echo "    <button type='button' class='btn btn-primary' 
																						data-toggle='modal' data-target='#myModal' data-form='/admin/getUser/".$User->Username."'>
																						Ubah
																						</button>";
																						echo "    <button type='button' class='btn btn-danger' 
																						data-toggle='modal' data-target='#myModal2' data-form='/admin/hapusUser/".$User->IdUser."/".$User->Username."'>
																						Hapus
																						</button>";
																			echo "  </td>";
																			echo "</tr>"; 
        ...
        <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" 	aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
								<form id='hapusForm' method='POST' action='<?php echo base_url(); ?>admin/hapusUser'>
