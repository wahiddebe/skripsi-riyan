													...
													<div class="row">
														<div class="col-lg-2 offset-md-10">
																<button type='button' style='margin-bottom:5px' class='btn btn-success'
																	data-toggle='modal' data-target='#myModal'data-form='/admin/getInstruksiKerja/-1'>
																	Tambah
																</button>
														</div>
													</div>
																	...
																	<?php
																		...
																		foreach($list as $InstruksiKerja)
																		{
																			...
																			echo "    <button type='button' class='btn btn-primary' 
																						...
																						data-form='/admin/getInstruksiKerja/".$InstruksiKerja->IdInstruksi."'>
																						Ubah
																						</button>";
																			echo "    <button type='button' class='btn btn-danger' 
																						data-toggle='modal' data-target='#myModal2' data-form='/admin/hapusInstruksiKerja/".$InstruksiKerja->IdInstruksi."/".$InstruksiKerja->Judul."'>
																						Hapus
																						</button>";
																			echo "  </td>";
																			echo "</tr>"; 
