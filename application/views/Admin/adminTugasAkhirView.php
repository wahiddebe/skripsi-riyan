								...
								<div class="register_content ">
									...
									<div class="row">
										<div class="col">
											<div class="list-data">
												<div class="col-md-12">
													<table id="TAdata" class="table table-bordered" cellspacing="0" width="100%">
														<thead>
															<tr>
																<!-- <td>No</td> -->
																<td>
																...
																<td>
																	<center>Nilai Pembimbing1
																</td>
																<td>
																	<center>Nilai Pembimbing2
																</td>
																<td>
																	<center>Nilai Penguji1
																</td>
																<td>
																	<center>Nilai Penguji2
																</td>
																<td>
																	<center>NilaiAkhir
																</td>
															...
															foreach ($list as $tugasAkhir) {
																...
																if ($penilaian != null) {
																	foreach ($penilaian as $penilaians) {
																		...
																		if ($penilaians->Penguji == $tugasAkhir->DosenPenguji1) {
																			$nilaipu1 = $penilaians->Nilai;
																		}
																		if ($penilaians->Penguji == $tugasAkhir->DosenPenguji2) {
																			$nilaipu2 = $penilaians->Nilai;
																		}
																		if ($penilaians->Penguji == $tugasAkhir->Pembimbing1) {
																			$nilaipb1 = $penilaians->Nilai;
																		}
																		if ($penilaians->Penguji == $tugasAkhir->Pembimbing2) {
																			$nilaipb2 = $penilaians->Nilai;
																		} else {
																		}
																	}
																}
																...
																if ($tugasAkhir->Pembimbing2 != '') {
																	if ($nilaipu1 != '' && $nilaipu2 != '' && $nilaipb1 != '' && $nilaipb2 != '') {
																		$total = $nilaipu1 + $nilaipu2 + $nilaipb1 + $nilaipb2;
																		$nilai = $total / 4;
																	}
																} else {
																	if ($nilaipu1 != '' && $nilaipu2 != '' && $nilaipb1 != '') {
																		$total = $nilaipu1 + $nilaipu2 + $nilaipb1;
																		$nilai = $total / 3;
																	}
																}
																echo $nilai;
