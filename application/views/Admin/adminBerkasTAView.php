    ...
    <div class="super_container"> 
														...
														<div class="row">
																<div class="col">
																	<div class="alert alert-success">
																			<strong>Sukses <?php echo $event ?> data Dokumen TA  "<?php echo $Judul ?>"</strong>
																	</div>
																</div>
															</div>
													<?php
													...
													<div class="row">
														<div class="col-lg-12 nopadding">
															<div class="section_title text-center">
																	<h1 >Data Dokumen TA</h1>
															</div>
														</div>
													</div>
													<div class="row">
														<div class="col-md-1.5">
														<?php echo form_open("PageController/cariDokumenTA"); ?>
													...
													<div class="row">
														<div class="col-lg-2 offset-md-10">
																<button type='button' style='margin-bottom:5px' class='btn btn-success'
																	data-toggle='modal' data-target='#myModal'data-form='/admin/getBerkasTA/-1'>
																	Tambah
																</button>
														</div>
													</div>
                                      ...
                                      <td>Judul</td>
																	...
																	<?php
																		...
																		foreach($list as $BerkasTA)
																		{
																			...
																			echo "	</td>";
																			echo "	<td>";
																			echo $BerkasTA->TanggalPembuatan;
																			echo "	</td>";
																			echo "	<td>";
																			if($BerkasTA->File != '')
																			{
																				echo "<a target='_blank' href='".base_url().$BerkasTA->File."'>".$BerkasTA->Judul.".pdf</a>";
																			}
																			else
																			{
																				echo "-";
																			...
																			echo "    <button type='button' class='btn btn-primary' 
																						...
																						data-form='/admin/getBerkasTA/".$BerkasTA->IdBerkas."'>
																						Ubah
																						</button>";
																			echo "    <button type='button' class='btn btn-danger' 
																						data-toggle='modal' data-target='#myModal2' data-form='/admin/hapusBerkasTA/".$BerkasTA->IdBerkas."/".$BerkasTA->Judul."'>
																						Hapus
																						</button>";
																			echo "  </td>";
																			echo "</tr>"; 
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Kelola Data Berkas TA</h4>
        ...
        <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" 	aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Hapus Data Berkas TA</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              </div>
              <div class="modal-body">
								<form id='hapusForm' method='POST' action='<?php echo base_url(); ?>admin/hapusBerkasTA'>
