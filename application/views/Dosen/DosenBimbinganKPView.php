...
<head>
    ...
    <title>Mahasiswa Bimbingan KP</title>
												...
												<div class="register_content ">
													...
													<div class="row">
														<div class="col">
															<div class="list-data">
															<div class="col-md-12">
															<table id="bimbingankp_data" class="table  table-bordered" cellspacing="0" width="100%">
																	<thead>
																		<tr>
																			<!-- <td>No</td> -->
                                      <td>Foto</td>
																	...
																	<?php
																		...
																		if(isset($list))
																		{
																			foreach($list as $kp)
																			{
																				...
																				if($kp->Foto!='')
																				{
																					echo "<img src='".base_url().$kp->Foto."' alt='Foto Mahasiswa'>";
																				}
																				else
																				{
