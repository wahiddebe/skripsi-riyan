												...
												<div class="register_content ">
														...
														<div class="row">
																<div class="col">
																	<div class="alert alert-success">
																			<strong>Pengajuan Sidang <?php echo $NIM?> berhasil disetujui!</strong>
																	</div>
																</div>
															</div>
													<?php
													...
													<div class="row">
														<div class="col">
															<div class="list-data">
															<div class="col-md-12">
															<table id="Sidang_data" class="table table-bordered" cellspacing="0" width="99%">
																	<thead>
																		<tr>
																			<!-- <td>No</td> -->
                                      <td>NIM</td>
                                    ...
                                    if(isset($list))
                                    {
                                        ...
                                        foreach($list as $sidang)
                                        {
                                            ...
                                            echo "    <button type='button' class='btn btn-primary' 
                                                        ...
                                                        data-form='/TU/getSidang/". $sidang->IdSidang."/persetujuan'>
                                                        Penyetujuan
                                                        </button>";
                                            echo "  </td>";
                                            echo "</tr>"; 
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Penyetujuan Sidang</h4>
