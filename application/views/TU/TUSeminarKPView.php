...
<head>
	...
	<title>Kelola Data Seminar KP</title>
			...
			<div>
											...
											<div class="row">
												<div class="col">
													<div class="alert alert-success">
														<strong>Sukses <?php echo $event ?> data seminar KP dengan NIM <?php echo $NIM ?></strong>
													</div>
												</div>
											</div>
									<?php
									...
									<div class="row">
										<div class="col">
											<div class="section_title text-center">
												<h1>Data Seminar KP Tersetujui</h1>
											</div>
										</div>
									</div>
									<a class="btn btn-success" href="<?php echo base_url() . 'PageController/export_excelseminar' ?>">Export Excel</a>
									<br>
									<br>
									<div class="row">
										<div class="col">
											<div class="list-data">
												<div class="col-md-12">
													<table id="seminar_data" class="table  table-bordered" cellspacing="0" width="100%">
														<thead>
															<tr>
																<!-- <td>No</td> -->
																<td>
																...
																<td>
																	<center>Tanggal Seminar
																</td>
																<td>
																	<center>Lokasi Seminar
																</td>
																<td>
																	<center>Waktu Seminar
																</td>
																<td>
																	<center>Status
																</td>
														...
														<tbody>
															...
															foreach ($list as $seminar) {
																...
																echo "	</td>";
																echo "	<td><center>";
																$kp = $this->KP->getDataByID($seminar->IdKP);
																$dosenpem = $this->Dosen->getDataBy($kp->DosenPembimbing);
																echo $dosenpem->Nama;
																echo "	</td>";
																echo "	<td>";
																echo $seminar->TanggalSeminarKP;
																echo "	</td>";
																echo "	<td>";
																echo $seminar->Lokasi;
																echo "	</td>";
																...
																echo "    <button type='button' class='btn btn-primary' 
																						...
																						data-form='/TU/getSeminarKP/" . $seminar->IdSeminarKP . "/ubah'>
																						Ubah
																						</button>";
																echo "    <button type='button' class='btn btn-danger' 
																						data-toggle='modal' data-target='#myModal2' data-form='/TU/hapusSeminarKP/" . $seminar->IdSeminarKP . "/" . $seminar->NIM . "'>
																						Hapus
																						</button>";
																echo "  </td>";
																echo "</tr>";
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h4 class="modal-title" id="myModalLabel">Ubah Data Seminar KP</h4>
				...
				<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h4 class="modal-title" id="myModalLabel">Hapus Data Seminar</h4>
								<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
							</div>
							<div class="modal-body">
								<form id='hapusForm' method='POST' action='<?php echo base_url(); ?>TU/hapusSeminarKP'>
