...
<head>
    ...
    <title>Kelola Data Seminar Tugas Akhir</title>
							...
							<div class="container">
									<div class="row">
														...
														<div class="row">
																<div class="col">
																	<div class="alert alert-success">
																			<strong>Sukses <?php echo $event ?> data seminar tugas akhir dengan NIM <?php echo $NIM ?></strong>
																	</div>
																</div>
															</div>
													<?php
													...
													<div class="row">
														<div class="col">
															<div class="section_title text-center">
																<h1>Data Seminar Tugas Akhir Tersetujui</h1>
															</div>
														</div>
													</div>
                                      ...
                                      <td><center>NIM</td>
																			...
																			<td><center>Tanggal Seminar</td>
																			<td><center>Lokasi Seminar</td>
																			<td><center>Waktu Seminar</td>
																			<td><center>Status</td>
																			<td>Aksi</td>
																		</tr>	
																	</thead>
																	...
																	<?php
																		...
																		foreach($list as $seminar)
																		{
																			...
																			echo "	</td>";
																			echo "	<td><center>";
																			echo $seminar->DosenPenguji1;
																			echo "	</td>";
																			echo "	<td><center>";
																			echo $seminar->DosenPenguji2;
																			echo "	</td>";
																			echo "	<td>";
																			...
																			echo "    <button type='button' class='btn btn-primary' 
																						...
																						data-form='/TU/getSeminar/".$seminar->IdSeminar."/ubah'>
																						Ubah
																						</button>";
																				echo "    <button type='button' class='btn btn-danger' 
																						data-toggle='modal' data-target='#myModal2' data-form='/TU/hapusSeminar/".$seminar->IdSeminar."/".$seminar->NIM."'>
																						Hapus
																						</button>";
																			echo "  </td>";
																			echo "</tr>"; 
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Ubah Data Seminar Tugas Akhir</h4>
        ...
        <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" 	aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
								<form id='hapusForm' method='POST' action='<?php echo base_url(); ?>TU/hapusSeminar'>
