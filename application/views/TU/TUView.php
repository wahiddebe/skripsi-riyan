                      ...
                      <div class="row">
                        <div class="col">
                          <div class="alert alert-success">
                            <strong>Pengajuan Seminar <?php echo $NIM ?> berhasil disetujui!</strong>
                          </div>
                        </div>
                      </div>
                  <?php
                            ...
                            <tbody>
                              ...
                              if (isset($list)) {
                                ...
                                foreach ($list as $seminar) {
                                  ...
                                  // echo "	</td>";
                                  echo "	<td>";
                                  echo "<a target='_blank' href='" . $seminar->LembarDaftar . "'>" . $seminar->NIM . "_LembarDaftar.pdf</a>";
                                  echo "	</td>";
                                  echo "	<td>";
                                  ...
                                  echo "    <button type='button' class='btn btn-primary' 
                                                            ...
                                                            data-form='/TU/getSeminar/" . $seminar->IdSeminar . "/persetujuan'>
                                                            Penyetujuan
                                                            </button>";
                                  echo "  </td>";
                                  echo "</tr>";
