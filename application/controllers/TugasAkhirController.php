            ...
            if ($this->session->userdata['role'] == 'admin') {
                ...
                if ($status ==  'approve') {
                    ...
                    foreach ($tugasAkhirApprove as $item) {
                        ...
                        $sidang = $this->Sidang->getDataByNIM($item->NIM);
                        $penilaian = null;
                        $item->DosenPenguji = "";
                        $item->DosenPenguji1 = "";
                        $item->DosenPenguji2 = "";
                        ...
                        if ($sidang != null) {
                            # code...
                            $penilaian = $this->Penilaian->getDataByIDSidang($sidang->IdSidang);
                            if ($sidang->DosenPenguji1 != null) {
                                $item->DosenPenguji1 = $sidang->DosenPenguji1;
                            }
                            if ($sidang->DosenPenguji2 != null) {
                                $item->DosenPenguji2 = $sidang->DosenPenguji2;
                            }
                        }
